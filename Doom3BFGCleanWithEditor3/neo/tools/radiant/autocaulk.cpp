	...
	*/
						{
							...
							v3ZeroTest = pSelectedFace->plane.Normal() + pScannedFace->plane.Normal();
							if (v3ZeroTest == v3Zero)
							{
								...
								{
									fTotalDist += fabs(	(pSelectedFace->plane.Normal() * (*pSelectedWinding)[0].ToVec3()) 
														- 
														(pSelectedFace->plane.Normal() * (*pScannedWinding)[i].ToVec3())
														);
								}
